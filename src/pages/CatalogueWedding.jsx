...
const CatalogueWedding = ({ products, favorites, toggleFavorite, addToCart }) => {
  const navigate = useNavigate();

  const weddingProducts = products.filter(product => 
    ["Ванильное облако", "Классическая невеста", "Пудровая нежность", 
     "Воздушная сказка", "Навсегда", "Шепот лепестков"].includes(product.title)
  );
  return (
    <div className="relative mx-auto max-w-6xl px-6 mb-16">
      ...
      <section className="pt-16">
        <div className="flex flex-col gap-6">
          <h1 className="text-4xl font-light">Свадебные</h1>
          <CatalogSection/>
...
export default CatalogueWedding; 