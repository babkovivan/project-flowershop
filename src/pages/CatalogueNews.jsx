...
const CatalogueNews = ({ products, favorites, toggleFavorite, addToCart }) => {
  const navigate = useNavigate();
  
  // Filter products to show only the specified flowers
  const newsProducts = products.filter(product => 
    ["С добрым словом", "Золотое дыхание", "Листопад чувств", 
     "Просто так", "Доброе сердце", "Нежнее нежного"].includes(product.title)
  );
    ...
    <div className="relative mx-auto max-w-6xl px-6 mb-16">
      ...
      <section className="pt-16">
        <div className="flex flex-col gap-6">
          <h1 className="text-4xl font-light">Новинки</h1>
          <CatalogueNav />
          ...
          <div className="flex justify-center mt-12">
            ...
            >
              ...
              {/* Цветочные декоративные элементы */}
